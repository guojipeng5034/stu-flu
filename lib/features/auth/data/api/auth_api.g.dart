...
class _AuthApi implements AuthApi {
  ...
  Future<ApiResponse<LoginResponse>> login(LoginRequest request) async {
    ...
    final _headers = <String, dynamic>{
      ...
      r'Authorization': 'Basic d2ViYXBwOndlYmFwcFNlY3VyaXR5',
      r'Content-Type': 'application/x-www-form-urlencoded',
      r'Signature': 'APP',
      r'Token':
          'cee43bd23972788874ba39279c7cbb7471572180bcdd2042518b30c3c4bd4dee1de1688ba6570662',
    };
    ...
    final _options = _setStreamType<ApiResponse<LoginResponse>>(
      Options(
        ...
        contentType: 'application/x-www-form-urlencoded',
          ...
          .compose(
            _dio.options,
            'https://gateway-dev.52cebu.com/auth/oauth2/token',
  ...
  @override
  Future<ApiResponse<void>> forgotPassword(Map<String, String> email) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
  ...
  @override
  Future<ApiResponse<void>> resetPassword(Map<String, String> data) async {
    final _extra = <String, dynamic>{};
    final queryParameters = <String, dynamic>{};
    final _headers = <String, dynamic>{};
    final _data = <String, dynamic>{};
